...
const { createPriceSchema, updatePriceSchema, getPriceSchema, queryPriceSchema } = require('./schema');
 ...
 */
router.get('/:com_index', (req, res, next) => {
	const { empresaBd } = req.query;
 ...
 */
router.patch('/:com_index', (req, res, next) => {
 ...
 */
router.delete('/:com_index', (req, res, next) => {
	const { empresaBd } = req.query;
